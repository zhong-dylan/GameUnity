...
// namespace tools
// {
//     public class StageShapesConfigure : EditorWindow
//     {
//         private string _excelFormworkFile = @"Assets/Editor/Formwork/stageFormwork.xlsx";
//         private string _excelPath = @"Assets/Editor/StageShapes/";
//         private string _jsonPath = @"Assets/Resources/TextAssets/Editor/StageShapes/";
//
//         private string _excelStageNamePref = "stage_";
//         private Dictionary<string, string> _excelStageList;
...
//
//         #region 编缉器入口
//         [MenuItem("Tools/关卡(形状)编辑", false, 201)]
//         public static void Open()
//         {
//             StageShapesConfigure window = EditorWindow.GetWindow<StageShapesConfigure>();
//             window.titleContent = new GUIContent("关卡(形状)编辑");
...
//         void OnEnable()
//         {
//             _excelStageList = new Dictionary<string, string>();
...
//             CalExcelsPath(_excelPath);
//         }
//
//         void CalExcelsPath(string path)
//         {
...
//                 {
//                     _excelStageList.Add(fileNameWithoutExtension, file);
//                 }
//                 else if (Path.GetFileName(file) != ".DS_Store" && Path.GetExtension(file) != ".meta")
//                 {
//                     Debug.LogError($"{path}: {Path.GetFileName(file)} 命名错误！");
//                 }
//             }
//
//             string[] direList = Directory.GetDirectories(path);
//             for (var i = 0; i < direList.Length; i++)
//             {
//                 //是路径
//                 if (Directory.Exists(direList[i]))
//                 {
//                     CalExcelsPath(direList[i]);
//                 }
//             }
//
...
//         {
//             string path = _excelPath + "temp.xlsx";
...
//             }
//
//             Debug.Log($"Excel[ temp.xlsx ] Create Success!");
//
//             _excelStageList.Add("temp", path);
//             //_excelStageList = _excelStageList.OrderByDescending(o => o.Key).ToDictionary(o => o.Key, p => p.Value);
//         }
//
//         void CalExcelTiles()
...
//
//             // name
//             //obj.Add("name", vo.vo_stageName);
//
//             // types
//             //JSONArray typeArray = new JSONArray();
//             //for (int i = 0; i < vo.vo_stageTileTypes.Count; i++)
//             //{
//             //    typeArray.Add(vo.vo_stageTileTypes[i].ToString());
//             //}
//             //obj.Add("types", typeArray);
//
//             // panel
